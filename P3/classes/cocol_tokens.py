...
class CocolProcessor:
    ...
    def generate_dfas(self):
        ...
        char = [str(ord("'"))] + ['('] + any_but_apostrophe + [')'] + [str(ord("'"))]
...
class CocolParser(CocolProcessor):
    ...
    def __init__(self, expresions, ignore, keywords) -> None:
        super().__init__()
    ...
    def generate_dfas(self):
        ...
        self.dfa.keywords = self.keywords
